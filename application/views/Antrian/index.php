<div class="container">
    <div class="row mb-4">
        <div class="col text-center">
            ...
            <p>Sudah Punya Nomor Antrian ? Masuk ke <a href="#!">Ruang Tunggu</a></p>
        </div>
    </div>
        ...
        <div class="col-md-6">
            <form method="POST" class="mb-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="alamat_pasien" id="alamat_pasien" class="form-control" required></textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="nomor_kis" name="nomor_kis" required>
                    </div>
                </div>
