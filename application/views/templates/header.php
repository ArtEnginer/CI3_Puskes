                ...
                <div class="col-md-12">
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light">
                        ...
                        <a href="<?php echo site_url(''); ?>" class="navbar-brand nav-brand2"><img
                                class="img img-responsive" width="35px;"
                                src="<?php echo base_url() . 'theme/images/kota.jpg' ?>"> UPT PUSKESMAS TANAH ABANG </a>

                        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                            <ul class="navbar-nav">
                                <div class="btn-group ">

                                    <a class="btn btn-outline-success" aria-haspopup="true" aria-expanded="false"
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item"
                                            href="<?php echo site_url('blog/kategori/pengumuman'); ?>">Pengumuman</a>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="<?php echo site_url('dokter'); ?>">Dokter dan
                                            Perawat</a> 
                                        <a class="dropdown-item" href="<?php echo site_url('staf'); ?>">Staff</a>
                                    </div>
                                </div>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="<?php echo site_url('luar'); ?>">Luar Gedung</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="<?php echo site_url('dalam'); ?>">Dalam
                                            Gedung</a>
                                    </div>
                                </div>
