                            ...
                            <ul class="navbar-nav">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="<?php echo site_url('aparat'); ?>">Dokter dan Perawat</a> <a class="dropdown-item" href="<?php echo site_url('aparatkel'); ?>">Staff</a>
                                        <div class="dropdown-divider"></div>
                                    </div>
                                </div>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="<?php echo site_url('nonijin'); ?>">Dalam Gedung</a>
                                    </div>
                                </div>
