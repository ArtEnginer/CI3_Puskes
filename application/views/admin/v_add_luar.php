    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Tambah Layanan Luar Gedung</li>
        </ol>
      </section>
      ...
      <section class="content">
        ...
        <div class="box box-default">
          ...
          <form action="<?php echo base_url() . 'adminkantor/luar/simpan_ijin' ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="col-md-8">
            ...
            <div class="box box-danger">
              <div class="box-header">
                <h3 class="box-title">Layanan Luar Gedung</h3>
              </div>
              <div class="box-body">
