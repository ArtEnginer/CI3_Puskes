      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Post Layanan</h3>
          </div>

          <form action="<?php echo base_url() . 'adminkantor/dalam/simpan_nonijin' ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="col-md-8">
            ...
            <div class="box box-danger">
              <div class="box-header">
                <h3 class="box-title">Layanan Dalam Gedung</h3>
              </div>
              <div class="box-body">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="xket" class="form-control" id="keterangan"required>
