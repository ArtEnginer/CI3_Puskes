              ...
              <div class="col-sm-7">
                <select name="xkelas" class="form-control" required>
                  ...
                  foreach ($kelas->result_array() as $k) {
                    $id_jabatan = $k['jabatan_id'];
                    $nm_jabatan = $k['jabatan_nama'];

                    ?>
                    <option value="<?php echo $id_jabatan; ?>"><?php echo $nm_jabatan; ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
                  ...
                  <select name="xkelas" class="form-control" required>
                    ...
                    foreach ($kelas->result_array() as $k) {
                      ...
                      <?php if ($id_jabatan == $jabatan_id) : ?>
                        <option value="<?php echo $id_jabatan; ?>" selected><?php echo $nm_jabatan; ?></option>
                      <?php else : ?>
                        <option value="<?php echo $id_jabatan; ?>"><?php echo $nm_jabatan; ?></option>
                      <?php endif; ?>
                    <?php } ?>
