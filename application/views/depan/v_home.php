...
<div class="container">
    <div class="row text-center">
        <div class="col">
            <div class="card shadow-lg bg-success rounded">
                <div class="card-body p-3">
                    <?php echo $jadwal['info']; ?>
                    <a class="btn btn-primary mt-3" role="button" href="<?= base_url() ?>antrian">Pendaftaran Pasien</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="event">
    ...
    <div class="container">
            ...
            <div class="col-12">
                <div class="row g-3">
                    <?php foreach ($berita->result() as $row) : ?>
                        <div class="col-4">
                            <div class="card p-3 mt-2 shadow-xl">

                                <div class="blog-single-item">

                                    <div class="blog-img_block">
                                        <div class="text-center">
                                            <img style="width:200px;height:200px;" src="<?php echo base_url() . 'assets/images/' . $row->tulisan_gambar; ?>" class="img-fluid" alt="blog-img">
                                    ...
                                    <div class="blog-title_block">
                                        ...
                                        <a href="<?php echo site_url('artikel/' . $row->tulisan_slug); ?>" class="btn btn-info text-center">
                                            Baca Selengkapnya
                                        </a>
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <h1 style="text-align:center">Agenda</h2>
            </div>
        </div>
